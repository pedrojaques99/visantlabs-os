...
export const AppsPage: React.FC = () => {
  ...
  const staticAppsData = useMemo(() => [
    ...
    { id: '3d-studio', name: t('apps.studio3d.name'), desc: t('apps.studio3d.description'), link: '/3d-studio', thumbnail: '/tools/3d-studio.png', badge: 'NEW', badgeVariant: 'free', category: 'effects', free: true, span: 'lg:col-span-1 lg:row-span-1' },
    { id: 'cmyk-halftone', name: t('apps.cmykHalftone.name'), desc: t('apps.cmykHalftone.description'), link: '/cmyk-halftone', thumbnail: '/tools/cmyk-halftone.png', badge: 'NEW', badgeVariant: 'free', category: 'effects', free: true, span: 'lg:col-span-1 lg:row-span-1' },
