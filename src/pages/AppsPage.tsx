...
export const AppsPage: React.FC = () => {
  ...
  const staticAppsData = useMemo(() => [
    ...
    { id: 'instagram-extractor', name: t('apps.instagramExtractor.name'), desc: t('apps.instagramExtractor.description'), link: '/instagram-extractor', thumbnail: '/tools/instagram-extractor.png', badge: 'NEW', badgeVariant: 'premium', category: 'design', free: false, span: 'lg:col-span-1 lg:row-span-1' },
