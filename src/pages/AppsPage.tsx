...
export const AppsPage: React.FC = () => {
  ...
  const staticAppsData = useMemo(() => [
    ...
    { id: 'riso-machine', name: 'Riso Machine', desc: 'Authentic risograph print simulator. Auto-extracts ink layers, halftone dots, misregistration, paper texture. Optional AI enhancement.', link: '/riso-machine', thumbnail: '/tools/cmyk-halftone.webp', badge: 'NEW', badgeVariant: 'free', category: 'effects', free: true, span: 'lg:col-span-1 lg:row-span-1' },
