...
export const AppsPage: React.FC = () => {
  ...
  const staticAppsData = useMemo(() => [
    ...
    { id: 'grid-machine', name: t('apps.gridMachine.name'), desc: t('apps.gridMachine.description'), link: '/grid-machine', thumbnail: '/tools/grid-machine.webp', badge: 'NEW', badgeVariant: 'free', category: 'design', free: true, span: 'lg:col-span-1 lg:row-span-1' },
