...
export const AdminProductsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    'credit_package' | 'subscription_plan' | 'storage_plan'
  >('credit_package');
    ...
    try {
      const defaultProducts = [
        // Credit Packages
        {
          ...
          priceBRL: 9.9,
          displayOrder: 0,
          paymentLinkBRL: 'https://buy.stripe.com/aFa6oA4A76hK2VUfVE0gw02',
        ...
        },
        {
          ...
          priceBRL: 25.9,
          displayOrder: 1,
          paymentLinkBRL: 'https://buy.stripe.com/9B6eV65EbdKc3ZYaBk0gw08',
        ...
        },
        {
          ...
          priceBRL: 45.9,
          displayOrder: 2,
          paymentLinkBRL: 'https://buy.stripe.com/28E00c4A7eOg0NM38S0gw09',
        ...
        },
        {
          ...
          priceBRL: 198.0,
          displayOrder: 3,
          paymentLinkBRL: 'https://buy.stripe.com/3cI8wI9Ur0Xq9ki5h00gw07',
        ...
        // Plans (créditos dobrados para validação agressiva - usuários não usam 100%)
        {
          ...
          priceBRL: 49.9,
          displayOrder: 4,
          description: '300 créditos/mês, Modo Experimental, Suporte Prioritário, 20GB Storage',
          metadata: { tier: 'pro', storageLimitGB: 20 },
        },
        {
          productId: 'plan_pro_annual',
          type: 'subscription_plan',
          name: 'Plano Pro Anual',
          credits: 3600,
          priceBRL: 499.0,
          displayOrder: 5,
          description: '3.600 créditos/ano, Modo Experimental, Suporte Prioritário, 20GB Storage',
          metadata: { tier: 'pro', storageLimitGB: 20, interval: 'year' },
        },
        {
          ...
          priceBRL: 89.9,
          displayOrder: 6,
          description: '800 créditos/mês, Modo Experimental, Suporte Rápido, 100GB Storage',
          metadata: { tier: 'vision', storageLimitGB: 100 },
        },
        {
          productId: 'plan_vision_annual',
          type: 'subscription_plan',
          name: 'Plano Vision Anual',
          credits: 9600,
          priceBRL: 899.0,
          displayOrder: 7,
          description: '9.600 créditos/ano, Modo Experimental, Suporte Rápido, 100GB Storage',
          metadata: { tier: 'vision', storageLimitGB: 100, interval: 'year' },
        },
        // Storage Plans (standalone, for BYOK users or additional storage)
        {
          ...
          priceBRL: 9.9,
          displayOrder: 8,
          description: '5 GB de armazenamento para imagens e vídeos',
          metadata: { storageLimitGB: 5, billingCycle: 'monthly' },
        },
        {
          productId: 'storage_vision',
          type: 'storage_plan',
          name: 'Vision Storage',
          credits: 0,
          priceBRL: 29.9,
          displayOrder: 9,
          description: '50 GB de armazenamento, ideal para criadores de vídeo',
          metadata: { storageLimitGB: 50, billingCycle: 'monthly' },
        },
      ];
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
              ...
              <p className="text-neutral-500 mt-1">
                {t('admin.products.gerencie_pacotes_de_crditos_e_plano')}
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <TabsList className="bg-neutral-900 border border-neutral-800 p-1">
                <TabsTrigger
                  ...
                  className="data-[state=active]:bg-neutral-800 data-[state=active]:text-brand-cyan"
                >
                  Pacotes de Créditos
                </TabsTrigger>
                <TabsTrigger
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center gap-2 py-2 px-3 bg-brand-cyan/5 border border-brand-cyan/20 rounded-md">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-[10px] text-neutral-400">
                              ...
                              até{' '}
                              {
                                product.metadata.unlimitedResolutions[
                                  product.metadata.unlimitedResolutions.length - 1
                                ]
                              }
                            </p>
                          </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2">
                      ...
                      <div className="flex flex-col gap-1">
                        <MicroTitle className="font-bold">
                          {t('admin.products.payments')}
                        </MicroTitle>
              ...
              {filteredProducts.length === 0 && !isLoading && (
                <div className="col-span-full py-12 text-center bg-neutral-900/50 border border-dashed border-neutral-800 rounded-xl">
                  ...
                  <p className="text-neutral-500">
                    {t('admin.products.nenhum_produto_encontrado_nesta_cat')}
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="bg-neutral-950 border border-neutral-800 w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-md shadow-2xl slide-in-from-bottom duration-300">
            <div className="p-6 border-b border-neutral-800 sticky top-0 bg-neutral-950 z-10 flex items-center justify-between">
              <div>
                ...
                <p className="text-neutral-500 text-sm">
                  {t('admin.products.preencha_os_detalhes_do_produto_e_l')}
                </p>
              </div>
              <Button
                variant="ghost"
                size="icon"
                aria-label={t('admin.products.fechar')}
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-neutral-500 uppercase ">
                    {t('admin.products.id_do_produto_nico')}
                  </label>
                  <Input
                ...
                <div className="space-y-2 md:col-span-2">
                  <label className="text-xs font-bold text-neutral-500 uppercase ">
                    {t('admin.products.nome_comercial')}
                  </label>
                  <Input
                ...
                {formData.type === 'subscription_plan' && (
                  <>
                    <div className="space-y-2 md:col-span-2">
                      <label className="text-xs font-bold text-neutral-500 uppercase ">
                        {t('admin.products.benefcios_um_por_linha_para_lista_e')}
                      </label>
                      <Textarea
                        placeholder={t('admin.products.benefcio_110benefcio_210benefcio_3')}
                        value={
                          formData.metadata?.features
                            ? Array.isArray(formData.metadata.features)
                              ? formData.metadata.features.join('\n')
                              : ''
                            : ''
                        }
                        onChange={(e) =>
                    ...
                    <div className="md:col-span-2 p-4 bg-neutral-900/50 border border-neutral-800 rounded-lg space-y-4">
                      ...
                      <p className="text-xs text-neutral-500">
                        Defina quais modelos/resoluções são ilimitados (não consomem créditos) para
                        este plano.
                      </p>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  storageLimitGB: parseInt(e.target.value) || 0,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                      ...
                      <div className="space-y-3">
                        <label className="text-xs font-bold text-neutral-500 uppercase">
                          {t('admin.products.resolues_unlimited_nb2')}
                        </label>
                      ...
                      <div className="space-y-3">
                        <label className="text-xs font-bold text-neutral-500 uppercase">
                          {t('admin.products.modelos_unlimited')}
                        </label>
                        <div className="flex flex-wrap gap-2">
                          {[
                            ...
                            {
                              id: 'veo-fast',
                              label: getModelDisplayName('veo-3.1-fast-generate-preview'),
                    ...
                    <div className="md:col-span-2 p-4 bg-neutral-900/50 border border-neutral-800 rounded-lg space-y-4">
                      ...
                      <p className="text-xs text-neutral-500">
                        Defina limites para proteger contra abuso, especialmente com unlimited
                        ativado.
                      </p>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxGenerationsPerDay: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxGenerationsPerHour: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxCanvasProjects: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                        ...
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.max_guidelines')}
                          </label>
                          <Input
                            type="number"
                            placeholder="∞"
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxBrandGuidelines: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.max_ref_images')}
                          </label>
                          <Input
                            type="number"
                            placeholder="13"
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxRefImagesPerGen: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxVideoSeconds: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                        ...
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.prioridade_fila')}
                          </label>
                          <Select
                    ...
                    <div className="md:col-span-2 p-4 bg-neutral-900/50 border border-neutral-800 rounded-lg space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-2">
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.max_membros_time')}
                          </label>
                          <Input
                            type="number"
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  maxTeamMembers: parseInt(e.target.value) || 1,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                        ...
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.reteno_histrico_dias')}
                          </label>
                          <Input
                            type="number"
                            placeholder="30"
                    ...
                    <div className="md:col-span-2 p-4 bg-neutral-900/50 border border-neutral-800 rounded-lg space-y-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.desconto_anual')}
                          </label>
                          <Input
                            type="number"
                            placeholder="20"
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  creditRolloverPercent: parseInt(e.target.value) || 0,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...
                                metadata: {
                                  ...formData.metadata,
                                  slaResponseHours: parseInt(e.target.value) || null,
                                },
                              })
                            }
                            className="bg-neutral-900 border-neutral-800 font-mono text-sm"
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-2">
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-neutral-500 uppercase">
                            {t('admin.products.badge_customizado')}
                          </label>
                          <Input
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-neutral-500 uppercase ">
                    {t('admin.products.preo_usd_opcional')}
                  </label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500">
                      $
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <MicroTitle as="label" className="pl-1 font-bold">
                        {t('admin.products.stripe_product_id')}
                      </MicroTitle>
                      <Input
                        placeholder="prod_..."
                    ...
                    <div className="space-y-1">
                      <MicroTitle as="label" className="pl-1 font-bold">
                        {t('admin.products.abacate_product_id')}
                      </MicroTitle>
                      <Input
                        placeholder="prod_..."
                        value={formData.abacateProductId}
                        onChange={(e) =>
                          setFormData({ ...formData, abacateProductId: e.target.value })
                        }
                        className="bg-neutral-900 border-neutral-800 text-xs font-mono"
                      />
                    </div>
                    <div className="space-y-1">
                      <MicroTitle as="label" className="pl-1 font-bold">
                        {t('admin.products.abacate_bill_id_pix')}
                      </MicroTitle>
                      <Input
                        placeholder="bill_..."
                        value={formData.abacateBillId}
                        onChange={(e) =>
                          setFormData({ ...formData, abacateBillId: e.target.value })
                        }
                        className="bg-neutral-900 border-neutral-800 text-xs font-mono"
                      />
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <MicroTitle as="label" className="pl-1 font-bold">
                        {t('admin.products.link_de_pagamento_brl_stripe')}
                      </MicroTitle>
                      <Input
                        placeholder="https://buy.stripe.com/..."
                        value={formData.paymentLinkBRL}
                        onChange={(e) =>
                          setFormData({ ...formData, paymentLinkBRL: e.target.value })
                        }
                    ...
                    <div className="space-y-1">
                      <MicroTitle as="label" className="pl-1 font-bold">
                        {t('admin.products.link_de_pagamento_usd_stripe')}
                      </MicroTitle>
                      <Input
                        placeholder="https://buy.stripe.com/..."
                        value={formData.paymentLinkUSD}
                        onChange={(e) =>
                          setFormData({ ...formData, paymentLinkUSD: e.target.value })
                        }
                        className="bg-neutral-900 border-neutral-800 text-xs"
                      />
                    </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-neutral-800">
                <div className="flex items-center gap-6">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="isActive" className="text-sm text-neutral-400">
                      {t('admin.products.produto_ativo')}
                    </label>
                  </div>
                  <div className="flex items-center gap-2">
