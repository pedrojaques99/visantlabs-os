      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:px-8 md:py-16">
        ...
        <div className="space-y-8 text-base leading-relaxed">
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400">{t('terms.sections.acceptance.content')}</p>
          </section>
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400 mb-3">{t('terms.sections.description.intro')}</p>
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400 mb-3">{t('terms.sections.acceptableUse.intro')}</p>
            <ul className="list-disc list-inside space-y-2 text-neutral-400 ml-4">
          ...
          <section className="pt-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-neutral-400 ml-4">
              {getArray('terms.sections.intellectualProperty.yourContent.items').map(
                (item, idx) => (
                  <li key={idx}>{item}</li>
                )
              )}
            ...
            <ul className="list-disc list-inside space-y-2 text-neutral-400 ml-4">
              {getArray('terms.sections.intellectualProperty.generatedImages.items').map(
                (item, idx) => (
                  <li key={idx}>{item}</li>
                )
              )}
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400 mb-3">{t('terms.sections.serviceAvailability.intro')}</p>
            <ul className="list-disc list-inside space-y-2 text-neutral-400 ml-4">
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400 mb-3">{t('terms.sections.rateLimits.intro')}</p>
            <ul className="list-disc list-inside space-y-2 text-neutral-400 ml-4">
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400">{t('terms.sections.disclaimers.asIs.content')}</p>
            ...
            <p className="text-neutral-400">{t('terms.sections.disclaimers.limitation.content')}</p>
          </section>
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400">{t('terms.sections.indemnification.content')}</p>
          </section>
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400">{t('terms.sections.modifications.content')}</p>
          </section>
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400 mb-3">{t('terms.sections.termination.intro')}</p>
            <ul className="list-disc list-inside space-y-2 text-neutral-400 ml-4">
          ...
          <section className="pt-8">
            ...
            <p className="text-neutral-400">{t('terms.sections.governingLaw.content')}</p>
          </section>
          ...
          <div className="pt-12 mt-8">
            <p className="text-sm text-neutral-500 ">{t('terms.sections.agreement')}</p>
          </div>
        </div>
      </div>
    </div>
