  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-300 relative">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-[30px] pb-16 md:pb-24">
        ...
        <div className="bg-neutral-900 border border-white/10 rounded-md shadow-2xl p-6 md:p-8">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-sm text-neutral-300 leading-relaxed">
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-neutral-400 ml-4">
                {getArray('privacy.sections.informationWeCollect.apiKeys.items').map(
                  (item, idx) => (
                    <li key={idx}>{item}</li>
                  )
                )}
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong class="text-neutral-300">${t(
                    'privacy.sections.informationWeCollect.apiKeys.important'
                  )}</strong>`,
                }}
              />
            </div>
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong class="text-neutral-300">${t(
                    'privacy.sections.howWeUseData.apiKeys.important'
                  )}</strong>`,
                }}
              />
            </div>
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <p
                className="text-neutral-400 mb-2"
                dangerouslySetInnerHTML={{
                  __html: t('privacy.sections.dataSharing.apiKeySharing.intro'),
                }}
              />
              <ul className="list-disc list-inside space-y-1 text-neutral-400 ml-4">
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-neutral-400 ml-4 mb-3">
                {getArray('privacy.sections.storageAndSecurity.apiKeySecurity.items').map(
                  (item, idx) => (
                    <li key={idx} dangerouslySetInnerHTML={{ __html: item }} />
                  )
                )}
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong class="text-neutral-300">${t(
                    'privacy.sections.storageAndSecurity.apiKeySecurity.responsibilities'
                  )}</strong>`,
                }}
              />
            </div>
