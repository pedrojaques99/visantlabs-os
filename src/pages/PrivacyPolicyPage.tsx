...
export const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-zinc-300 relative">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 pt-[30px] pb-16 md:pb-24">
        <button
          onClick={() => navigate('/')}
          className="mb-8 flex items-center gap-2 text-zinc-400 hover:text-zinc-200 transition-colors font-mono text-sm"
        >
          <ArrowLeft size={16} />
        ...
        <div className="bg-zinc-900 border border-zinc-800/50 rounded-md shadow-2xl p-6 md:p-8">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-sm text-zinc-300 leading-relaxed">
            ...
            <div className="border-t border-zinc-800/50 pt-6">
              ...
              <h3 className="text-base font-semibold text-zinc-300 mt-4 mb-2">{t('privacy.sections.informationWeCollect.apiKeys.title')}</h3>
              <p className="text-zinc-400 mb-2">
              ...
              <p className="text-zinc-400 mt-3" dangerouslySetInnerHTML={{ __html: `<strong class="text-zinc-300">${t('privacy.sections.informationWeCollect.apiKeys.important')}</strong>` }} />
            </div>
            ...
            <div className="border-t border-zinc-800/50 pt-6">
              ...
              <h3 className="text-base font-semibold text-zinc-300 mt-4 mb-2">{t('privacy.sections.howWeUseData.apiKeys.title')}</h3>
              <p className="text-zinc-400 mb-2">
              ...
              <p className="text-zinc-400" dangerouslySetInnerHTML={{ __html: `<strong class="text-zinc-300">${t('privacy.sections.howWeUseData.apiKeys.important')}</strong>` }} />
            </div>
            ...
            <div className="border-t border-zinc-800/50 pt-6">
              ...
              <h3 className="text-base font-semibold text-zinc-300 mt-4 mb-2">{t('privacy.sections.dataSharing.apiKeySharing.title')}</h3>
              <p className="text-zinc-400 mb-2" dangerouslySetInnerHTML={{ __html: t('privacy.sections.dataSharing.apiKeySharing.intro') }} />
              <ul className="list-disc list-inside space-y-1 text-zinc-400 ml-4">
            ...
            <div className="border-t border-zinc-800/50 pt-6">
              ...
              <h3 className="text-base font-semibold text-zinc-300 mt-4 mb-2">{t('privacy.sections.storageAndSecurity.apiKeySecurity.title')}</h3>
              <p className="text-zinc-400 mb-2">
              ...
              <p className="text-zinc-400 mt-3" dangerouslySetInnerHTML={{ __html: `<strong class="text-zinc-300">${t('privacy.sections.storageAndSecurity.apiKeySecurity.responsibilities')}</strong>` }} />
            </div>
            ...
            <div className="border-t border-zinc-800/50 pt-6">
              ...
              <h3 className="text-base font-semibold text-zinc-300 mt-4 mb-2">{t('privacy.sections.dataRetention.apiKeys.title')}</h3>
              <p className="text-zinc-400 mb-2">
