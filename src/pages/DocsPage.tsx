...
export const DocsPage: React.FC = () => {
  ...
  const getMarkdown = useCallback(
    (tab: string) =>
      generateTabMarkdown(tab as any, mcpSpec, openApiSpec, platformMcpSpec, pricingData),
    ...
    return (
      <Card id={idPrefix} className="border-none bg-transparent shadow-none">
        <CardHeader className="px-0 pt-0">
          <CardTitle className="text-2xl border-b border-border pb-2 mb-4">
            {title} Endpoints
          </CardTitle>
        </CardHeader>
          ...
          {endpoints.map((ep, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-redhatmono text-lg text-foreground font-medium">
                  {ep.path}
                </span>
              </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm md:text-base mt-1">
                          Complete API, MCP, and Plugin documentation for the Visant design
                          platform.
                        </p>
                      </div>
                    </div>
                  ...
                  <TabsContent value="overview" className="space-y-6 bg-transparent mt-0">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      >
                        ...
                        <CardContent>
                          <p className="text-muted-foreground text-sm">
                            Centralized brand identity vaults with automated context extraction for
                            AI agents.
                          </p>
                        </CardContent>
                      </Card>
                    ...
                    <Card className="mt-8">
                      <CardHeader>
                        ...
                        <CardDescription>
                          How to authenticate and make requests to Visant Copilot.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div>
                          <h3 className="text-lg font-medium mb-2">1. Authentication</h3>
                          <p className="text-muted-foreground mb-3 font-sm">
                            All API requests require authentication via JWT token or API key in the
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground mb-3 font-sm">
                            All responses are in JSON. Success returns a 200 or 201 code with{' '}
                            <code className="bg-secondary px-1 py-0.5 rounded text-xs">{`{ "success": true, "data": ... }`}</code>
                            .
                          </p>
                        </div>
                      </CardContent>
                  ...
                  <TabsContent value="api" className="space-y-10 mt-0">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Complete documentation for the Visant Copilot HTTP endpoints.
                      </p>
                    </div>
                  ...
                  <TabsContent value="mcp" className="space-y-8 mt-0">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        ...
                        for mockups, canvas, branding, and <strong>Figma MCP</strong> (stdio) for
                        direct Figma manipulation.
                      </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="bg-secondary/40 border border-border rounded-md p-5">
                            ...
                            <p className="text-muted-foreground text-xs mb-3">
                              ...
                              Figma plugin sandbox via WebSocket bridge.
                            </p>
                            <div className="space-y-1 text-xs text-muted-foreground">
                              <p>
                                Command:{' '}
                    ...
                    <Card id="mcp-getting-started" className="border border-border bg-card">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Connect any LLM to Visant Labs in 3 steps.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="space-y-3">
                          {[
                            ...
                            {
                              n: 2,
                              title: 'Add to your LLM client',
                              desc: (
                                <span>
                                  See <strong>Code Snippets</strong> below for Claude.ai, Cursor,
                                  Node.js, and Python examples. The MCP endpoint is{' '}
                                  <code className="font-redhatmono bg-secondary px-1 rounded">
                                    POST /api/mcp
                                  </code>
                                  .
                            ...
                            },
                            {
                              ...
                              desc: (
                                <span>
                                  Ask: <em>"List my brand guidelines"</em> or{' '}
                                  <em>
                                    "Generate a mockup for coffee packaging using my Feira 2026
                                    brand"
                                  </em>
                                </span>
                              ),
  ...
  -d '{"jsonrpc":"2.0","method":"tools/list","id":1}'`}</pre>
                    ...
                    <Card id="mcp-setup" className="border border-border bg-card">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Configuration examples for popular AI clients.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div>
...
const result = await client.callTool({
    ...
    model: "gemini-2.5-flash"
                    ...
                    <Card id="mcp-auth" className="border border-border bg-card">
                      <CardHeader>
                        ...
                        <CardDescription>
                          API keys are required for the Platform MCP server. The Figma MCP server
                          authenticates through the plugin connection.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        ...
                        <div className="bg-secondary/30 rounded-md border border-border p-4">
                          <p className="text-xs text-muted-foreground">
                            ...
                            <code className="font-redhatmono bg-secondary px-1 rounded">_meta</code>{' '}
                            field with your remaining credits, so your agent can track usage
                            automatically.
                          </p>
                        </div>
                      </CardContent>
                    ...
                    <Card id="pl-install" className="scroll-mt-20">
                      ...
                      <CardContent>
                        <ol className="list-decimal pl-5 space-y-2 text-muted-foreground text-sm">
                          ...
                          <li>
                            Go to{' '}
                            <strong className="text-foreground">Resources {'>'} Plugins</strong> and
                            search for <strong className="text-foreground">Visant Copilot</strong>.
                          </li>
                          <li>
                            Click <strong className="text-foreground">Run</strong> to launch the
                            plugin panel.
                          </li>
                          <li>
                            Sign in with your Visant account to unlock brand-aware features and
                      ...
                      <CardContent className="space-y-4">
                        <ul className="space-y-3 list-none">
                          {[
                            ...
                            [
                              'Multimodal input',
                              'Drag-and-drop or paste images directly into the chat input for visual context.',
                            ],
                            [
                              'Brand context',
                              'Select a Brand Guideline to inject colors, typography, and tone into every prompt.',
                            ],
                            ['/clear command', 'Type /clear to reset chat history.'],
                            [
                              'Clickable layer refs',
                              'Operation summaries show @"LayerName" links that select and zoom to the referenced layer.',
                            ],
                            [
                              'Copy & select',
                            ...
                            <li key={title} className="flex items-start gap-3">
                              ...
                              <div>
                                <strong className="block text-foreground border-none text-sm">
                                  {title}
                                </strong>
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {cat.ops.map((op) => (
                                <Badge
                                  key={op}
                                  variant="secondary"
                                  className="font-redhatmono text-xs"
                                >
                                  {op}
                                </Badge>
                              ))}
                    ...
                    <Card id="pl-brand" className="scroll-mt-20">
                      ...
                      <CardContent className="space-y-3">
                        <ul className="space-y-2 text-muted-foreground text-sm list-disc pl-5">
                          <li>
                            Select a brand guideline from the sidebar to inject identity context
                            (colors, typography, tone) into every AI prompt.
                          </li>
                          <li>
                    ...
                    <Card id="pl-scan" className="scroll-mt-20">
                      ...
                      <CardContent>
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          When the AI needs context beyond the current selection, it automatically
                          emits a{' '}
                          <code className="font-redhatmono bg-secondary px-1 rounded">
                            REQUEST_SCAN
                          </code>{' '}
                          operation. This triggers a full page scan, re-sending the command with
                          complete page context. The scan status appears as a tool call in the chat
                          UI.
                        </p>
                      </CardContent>
                    </Card>
                       ...
                       ◀── APPLY_OPERATIONS ──────────`}</pre>
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground text-sm mb-3">
                            Stateless endpoint. Receives serialized selection + brand context + user
                            prompt. Returns{' '}
                            <code className="font-redhatmono bg-secondary px-1 rounded">
  ...
  { "type": "CREATE_TEXT", "parentRef": "card", "props": { "content": "Hello", "fontSize": 16 } }
                          ...
                          <p className="text-muted-foreground text-xs mt-2">
                            <code className="font-redhatmono bg-secondary px-1 rounded">ref</code>{' '}
                            creates a named reference;{' '}
                            <code className="font-redhatmono bg-secondary px-1 rounded">
                              parentRef
                            </code>{' '}
                            nests inside a previously created node;{' '}
                            <code className="font-redhatmono bg-secondary px-1 rounded">
                              parentNodeId
                            </code>{' '}
                            nests inside an existing Figma node by ID.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <TabsContent value="figma-nodes" className="space-y-8 mt-0">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Data-driven pattern for creating Figma nodes via Plugin API. Define layouts
                        in JSON, execute in the plugin sandbox.
                      </p>
                    </div>
                    ...
                    <Card id="fn-overview">
                      <CardHeader>
                        ...
                        <CardDescription>
                          ...
                          is parsed and executed by a renderer utility.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="bg-secondary/30 rounded-md border border-border p-4">
...
4. buildNode() — recursively create all nodes`}</pre>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mt-4">
                          {[
                            {
                              type: 'FRAME',
                              desc: 'Container with auto-layout, padding, fills',
                              supports: 'children',
                            },
                            {
                              type: 'RECTANGLE',
                              desc: 'Solid or gradient-filled box',
                              supports: 'fills, effects',
                            },
                            {
                              type: 'ELLIPSE',
                              desc: 'Circle or oval shape',
                              supports: 'fills, strokes',
                            },
                            {
                              type: 'TEXT',
                              desc: 'Text with full typography control',
                              supports: 'font, spacing',
                            },
                          ].map((n) => (
                            <div
                              key={n.type}
                            ...
                            >
                              ...
                              <p className="text-muted-foreground/60 text-xs mt-1 font-redhatmono">
                                {n.supports}
                              </p>
                            </div>
                          ))}
                      ...
                      <CardContent className="space-y-4">
                        <div className="border border-border rounded-md overflow-hidden">
                          <table className="w-full text-sm text-left">
                            <thead className="bg-secondary/50">
                              <tr>
                                <th className="px-4 py-3 font-medium text-foreground w-44">
                                  Property
                                </th>
                            ...
                            <tbody className="divide-y divide-border">
                              {[
                                ...
                                [
                                  'width / height',
                                  'number',
                                  'Geometry. Applied via resize() internally.',
                                ],
                                [
                                  'fills',
                                  'FillSpec[]',
                                  'Array of solid or gradient fills. Empty array = transparent.',
                                ],
                                ...
                                [
                                  'letterSpacing',
                                  'object',
                                  "{ unit: 'PERCENT' | 'PIXELS', value: number }",
                                ],
                                [
                                  'lineHeight',
                                  'object',
                                ...
                                <tr key={prop} className="bg-card">
                                  ...
                                  <td className="px-4 py-2.5">
                                    <span className="bg-secondary px-2 py-0.5 rounded text-xs font-redhatmono text-muted-foreground">
                                      {type}
                                    </span>
                                  </td>
                    ...
                    <Card id="fn-fills">
                      ...
                      <CardContent className="space-y-4">
                        <div>
                          <h4 className="font-redhatmono text-xs uppercase text-muted-foreground mb-2">
                            Solid Fill
                          </h4>
                          <div className="bg-secondary/30 rounded-md border border-border overflow-hidden">
                            <div className="bg-secondary/50 px-4 py-2 border-b border-border font-redhatmono text-xs text-muted-foreground uppercase ">
  ...
  "blendMode": "NORMAL"
                    ...
                    <Card id="fn-rules">
                      <CardHeader>
                        ...
                        <CardDescription>
                          These mistakes will silently fail or produce wrong results.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="border border-border rounded-md overflow-hidden">
                            ...
                            <tbody className="divide-y divide-border">
                              {[
                                ...
                                [
                                  ...
                                  'width and height are read-only on all nodes. Call node.resize(w, h).',
                                ],
                                [
                                  'Load fonts before text edits',
                                  'figma.loadFontAsync({ family, style }) must complete before setting characters, fontSize, fontName, etc.',
                                ],
                                [
                                  'appendChild before layoutSizing',
                                  'layoutSizingHorizontal/Vertical only works after the node is a child of an auto-layout frame.',
                                ],
                                [
                                ...
                                [
                                  ...
                                  "layoutSizingHorizontal: 'FILL' only works if the parent frame has layoutMode set.",
                                ],
                                [
                                  'Empty fills = transparent',
                                  "fills: [] removes all fills. Don't omit the field if you want transparency.",
                                ],
                              ].map(([rule, detail]) => (
                    ...
                    <Card id="fn-renderer">
                      ...
                      <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {[
                            {
                              fn: 'collectFonts(spec, fonts)',
                              desc: 'Recursively walks the spec tree and collects all fontName values into a Set<string>.',
                            },
                            {
                              fn: 'applyFills(node, fills)',
                              desc: 'Maps FillSpec[] to Figma Paint[] and assigns to node.fills or node.strokes.',
                            },
                            {
                              fn: 'buildNode(spec, parent)',
                              desc: 'Creates the correct node type, sets all properties, appends to parent, recurses into children.',
                            },
                            {
                  ...
                  <TabsContent value="canvas-api" className="space-y-8 mt-0">
                      ...
                      <CardContent className="space-y-4">
                          ...
                          {[
                            {
                              ...
                              desc: 'POST /api/canvas with an initial nodes[] and edges[] array.',
                            },
                            {
                              step: '2',
                              title: 'Read & Modify Nodes',
                              desc: 'GET /api/canvas/:id to fetch current state. Modify the nodes array locally.',
                            },
                            {
                              step: '3',
                              title: 'Persist Changes',
                              desc: 'PUT /api/canvas/:id with the full updated nodes[] and edges[] to save.',
                            },
                          ].map(({ step, title, desc }) => (
                        ...
                        <div className="bg-secondary/30 rounded-md border border-border p-4">
                          ...
                          <p className="text-sm text-muted-foreground">
                            There is no individual node endpoint. Nodes are stored as a JSON array
                            inside the project document. To add, update, or remove a node, fetch the
                            project, mutate the nodes array, and PUT the full array back.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card id="ca-auth">
                      <CardHeader>
                        <CardTitle>Authentication</CardTitle>
                        <CardDescription>
                          All endpoints require a JWT Bearer token except the public shared-project
                          endpoint.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
...
{ "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..." }`}</pre>
                        ...
                        <p className="text-muted-foreground text-sm">
                          Rate limits: 60 requests/min for general endpoints, 10 uploads/15 min for
                          media uploads.
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card id="ca-projects">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Create, read, update, and delete canvas projects. Each project stores a
                          name, a nodes array, and an edges array.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        {[
                          ...
                          },
                          {
                            ...
                            path: '/api/canvas/:id',
                            summary:
                              'Get a single project by ID. Returns nodes with expired base64 data cleaned.',
  ...
  "edges": []
                          ...
                          },
                          {
                            ...
                            path: '/api/canvas/:id',
                            summary:
                              'Update a project. Send only the fields you want to change. To update nodes, send the full updated nodes array.',
                            request: `{
  ...
  "drawings": [...]                // optional — freehand drawing data
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <span className="font-redhatmono text-foreground font-medium">
                                {path}
                              </span>
                            </div>
                            ...
                            {request && (
                              <div className="bg-secondary/30 rounded-md border border-border overflow-hidden">
                                ...
                                <pre className="p-4 text-xs font-redhatmono text-foreground m-0 overflow-x-auto">
                                  {request}
                                </pre>
                              </div>
                            )}
                    ...
                    <Card id="ca-nodes">
                      <CardHeader>
                        ...
                        <CardDescription>
                          All 23 node types available in the canvas. Each node must have an{' '}
                          <code className="bg-secondary px-1 py-0.5 rounded text-xs">id</code>,{' '}
                          <code className="bg-secondary px-1 py-0.5 rounded text-xs">type</code>,{' '}
                          <code className="bg-secondary px-1 py-0.5 rounded text-xs">position</code>
                          , and a{' '}
                          <code className="bg-secondary px-1 py-0.5 rounded text-xs">data</code>{' '}
                          object with{' '}
                          <code className="bg-secondary px-1 py-0.5 rounded text-xs">type</code>{' '}
                          matching the node type.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div className="bg-secondary/30 rounded-md border border-border overflow-hidden">
                            ...
                            <tbody className="divide-y divide-border">
                              {[
                                [
                                  ...
                                  'prompt (string), model, aspectRatio, resolution, resultImageUrl',
                                ],
                                [
                                  'image',
                                  'Display an existing mockup or image',
                                  'mockup: { imageUrl, imageBase64, ... }',
                                ],
                                [
                                  'output',
                                ...
                                [
                                  'merge',
                                  'Combine 2+ connected images with AI',
                                  'prompt (string), model, resultImageUrl',
                                ],
                                [
                                  'edit',
                                  'Edit image with Mockup Machine settings',
                                  'uploadedImage, referenceImage, tags[], model, resolution, designType',
                                ],
                                [
                                  'upscale',
                                  'AI upscaling (Gemini)',
                                  'targetResolution, resultImageUrl, connectedImage',
                                ],
                                [
                                  'upscaleBicubic',
                                  'Bicubic shader upscaling',
                                  'scaleFactor, sharpening, resultImageUrl, resultVideoUrl',
                                ],
                                [
                                  'mockup',
                                  'AI mockup from preset templates',
                                  'selectedPreset, selectedColors[], withHuman, customPrompt, model',
                                ],
                                [
                                  'angle',
                                  'Re-render with camera angle preset',
                                  'selectedAngle, resultImageUrl, connectedImage',
                                ],
                                [
                                  'texture',
                                  'Apply 3D texture/style preset',
                                  'selectedPreset, resultImageUrl, connectedImage',
                                ],
                                [
                                  'ambience',
                                  'Apply background/environment preset',
                                  'selectedPreset, resultImageUrl, connectedImage',
                                ],
                                [
                                  'luminance',
                                  'Apply light setup preset',
                                  'selectedPreset, resultImageUrl, connectedImage',
                                ],
                                [
                                  'shader',
                                  'GLSL shader effects (halftone, VHS, ASCII…)',
                                  'shaderType, dotSize, angle, contrast, resultVideoUrl',
                                ],
                                [
                                  'colorExtractor',
                                  'Extract color palette from image',
                                  'connectedImage, extractedColors: string[]',
                                ],
                                [
                                  'text',
                                  'Editable text block (connects to prompt/chat)',
                                  'text (string)',
                                ],
                                ...
                                [
                                  'videoInput',
                                  'Video upload for shader/processing nodes',
                                  'uploadedVideoUrl',
                                ],
                                [
                                  'video',
                                  'Video generation via Veo',
                                  'prompt, model, aspectRatio, duration, mode, resultVideoUrl',
                                ],
                                [
                                  'brand',
                                  'Brand identity extractor (legacy)',
                                  'logoImage, identityPdfUrl, brandIdentity',
                                ],
                                [
                                  'brandCore',
                                ...
                                [
                                  'strategy',
                                  'Brand strategy generation (persona, archetypes…)',
                                  'strategyType, prompt, strategyData',
                                ],
                                [
                                  'director',
                                  'AI-assisted prompt builder with tag selection',
                                  'connectedImage, suggestedTags, generatedPrompt',
                                ],
                                [
                                  'chat',
                                  'Conversational AI with multimodal context',
                                  'messages[], model, systemPrompt, connectedImage1..4',
                                ],
  ...
  "data": { "type": "prompt", "prompt": "" }
                    ...
                    <Card id="ca-edges">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Edges are React Flow edges connecting node outputs to node inputs. They
                          drive data flow between nodes (e.g. an image node feeding into a merge
                          node).
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
    ...
    "targetHandle": "input"
                    ...
                    <Card id="ca-media">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Upload images, PDFs, and videos to R2 storage and get back a persistent
                          URL to embed in node data.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        {[
                          {
                            method: 'POST',
                            path: '/api/canvas/image/upload',
                            summary:
                              'Upload an image (base64) to R2. Returns a URL to store in node data fields like resultImageUrl or imageUrl.',
                          ...
                          {
                            method: 'GET',
                            path: '/api/canvas/image/upload-url',
                            summary:
                              'Get a presigned URL for direct R2 upload (bypasses server size limits). Use for large images (>10 MB).',
                          ...
                          {
                            method: 'GET',
                            path: '/api/canvas/video/upload-url',
                          ...
                          {
                            method: 'POST',
                            path: '/api/canvas/pdf/upload',
                            summary:
                              'Upload a PDF (base64) to R2. PDF is compressed before upload.',
                          ...
                          {
                            method: 'DELETE',
                            path: '/api/canvas/image?url=<encoded>',
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <span className="font-redhatmono text-foreground font-medium text-sm">
                                {path}
                              </span>
                            </div>
                            <p className="text-muted-foreground text-sm">{summary}</p>
                    ...
                    <Card id="ca-share">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Share projects publicly or with specific users by email or user ID.
                          Requires Admin or Premium subscription.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-5">
                        {[
                          {
                            ...
                            summary:
                              'Enable sharing on a project. Generates a shareId and sets collaboration permissions.',
                          ...
                          {
                            method: 'PUT',
                            path: '/api/canvas/:id/share-settings',
                            summary:
                              'Update collaboration permissions for an existing shared project.',
  ...
  body: JSON.stringify({ nodes: [...project.nodes, imageNode], edges: project.edges })
                        ...
                        <div className="bg-card border border-warning/20 rounded-md p-4">
                          ...
                          <ul className="space-y-1.5 text-sm text-muted-foreground">
                            <li>
                              • <strong className="text-foreground">Node IDs must be unique</strong>{' '}
                              within a project. Use a UUID or timestamp-based suffix.
                            </li>
                            <li>
                              •{' '}
                            ...
                            <li>
                              ...
                              project. Max 15 MB payload after R2 offload.
                            </li>
                          </ul>
                        </div>
                      </CardContent>
                    ...
                    <Card id="ca-json">
                      <CardHeader>
                        ...
                        <CardDescription>
                          The{' '}
                          <code className="font-redhatmono text-xs bg-secondary px-1 rounded">
                            visant-canvas/v1
                          </code>{' '}
                          schema used to save and restore complete canvas workflows as portable JSON
                          files.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
  ...
  drawings: any[];    // free-draw strokes (may be empty array)
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mb-3">
                            The following fields are removed from node data before export to keep
                            files portable and compact:
                          </p>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div className="bg-secondary/20 rounded-md border border-border p-3">
                              <p className="font-redhatmono text-xs text-muted-foreground uppercase mb-2">
                                Large binary data (kept as R2 URLs)
                              </p>
                            ...
                            <div className="bg-secondary/20 rounded-md border border-border p-3">
                              <p className="font-redhatmono text-xs text-muted-foreground uppercase mb-2">
                                Transient / recomputed from edges
                              </p>
                              <ul className="space-y-0.5 text-xs font-redhatmono text-foreground">
                                {[
                                  'connectedImages',
                        ...
                        <div className="bg-card border border-brand-cyan/20 rounded-md p-4">
                          ...
                          <ul className="space-y-1.5 text-sm text-muted-foreground">
                            ...
                            <li>
                              ...
                              fields are kept, so files are human-readable and reproducible.
                            </li>
                            <li>
                              • On import, a{' '}
                              <strong className="text-foreground">
                      ...
                      <CardHeader>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <CardDescription>
                              Structured brand identity context for AI agents
                            </CardDescription>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div id="bg-overview" className="scroll-mt-20">
                          <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                            ...
                            with colors, typography, and tone of voice.
                          </p>
                        </div>
  ...
  "guidelines": { "voice": "Professional", "dos": [], "donts": [] }
                        ...
                        <div id="bg-sharing" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-4">
                            Guidelines can be shared publicly via a unique slug. This allows
                            external tools and reviewers to access brand data without
                            authentication.
                          </p>
                          <div className="bg-secondary/40 border border-border rounded-md p-4">
                            <div className="font-redhatmono text-xs space-y-2">
                        ...
                        <div id="bg-context" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-4">
                            ...
                            endpoint to get a version of the guideline optimized for prompt
                            injection.
                          </p>
                    ...
                    <Card className="bg-card border border-border">
                      <CardHeader>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <CardDescription>
                              Connect AI agents and LLMs to the Visant Labs platform
                            </CardDescription>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="space-y-6">
                          ...
                          {platformMcpSpec?.tools &&
                            (() => {
                              ...
                              const categoryLabels: Record<string, string> = {
                                ...
                                ai: 'AI Prompt & Analysis',
                                branding: 'Brand Identity',
                                'brand-guidelines': 'Brand Guidelines',
                                canvas: 'Canvas',
                                budget: 'Budget',
                                community: 'Community (no auth)',
                                      ...
                                      <tbody className="divide-y divide-border/50">
                                        {tools.map((tool) => (
                                          <tr key={tool.name} className="hover:bg-secondary/20">
                                            <td className="p-3 font-redhatmono text-foreground text-xs w-64 shrink-0">
                                              {tool.name}
                                            </td>
                        ...
                        <div id="ag-brand-guidelines" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-3">
                            Guidelines are centralized identity vaults. Use the{' '}
                            <code className="font-redhatmono bg-secondary px-1 rounded">
                              /context
                            </code>{' '}
                            endpoint for optimized prompt context.
                          </p>
                          <div className="bg-secondary/40 border border-border rounded-md p-4 mb-4">
                            <div className="font-redhatmono text-xs space-y-2">
                              ...
                              <p className="text-muted-foreground text-xs mt-1">
                                Query params:{' '}
                                <code className="text-foreground">format=prompt|structured</code>,{' '}
                                <code className="text-foreground">output=text|json</code>
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div id="ag-credits" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-3">
                            Every MCP tool response includes quota info in{' '}
                            <code className="font-redhatmono bg-secondary px-1 rounded">_meta</code>
                            :
                          </p>
                          ...
                          <div className="space-y-3 text-sm">
                            {[
                              ...
                              },
                              {
                                ...
                                desc: 'SSE connect to /api/mcp with Authorization header',
                              },
                              {
                                step: '3',
                              ...
                              {
                                step: '4',
                                title: 'Extract & enrich',
                                desc: 'ai-extract-colors on logo, brand-generate-persona, brand-generate-archetype',
                              },
                              {
                                step: '5',
                                title: 'Build prompts',
                              ...
                              },
                              {
                                ...
                                desc: 'mockup-batch-generate (up to 20 in parallel), check _meta.credits_remaining',
                              },
                            ].map(({ step, title, desc }) => (
                              <div
                                key={step}
                    ...
                    <Card className="bg-card border border-border">
                      ...
                      <CardContent className="space-y-6">
                        <div id="pr-google" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-4">
                            Our credit costs are derived from{' '}
                            <a
                            ...
                            <table className="w-full text-sm border border-border rounded-md">
                              ...
                              <tbody>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 2.5 Flash Image</td>
                                  <td className="p-2">~1K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.039</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 3.1 Flash Image</td>
                                  <td className="p-2">512px</td>
                                  <td className="p-2 text-right font-redhatmono">$0.045</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 3.1 Flash Image</td>
                                  <td className="p-2">1K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.067</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 3.1 Flash Image</td>
                                  <td className="p-2">2K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.101</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 3.1 Flash Image</td>
                                  <td className="p-2">4K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.151</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 3 Pro Image</td>
                                  <td className="p-2">1K/2K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.134</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Gemini 3 Pro Image</td>
                                  <td className="p-2">4K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.24</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                          ...
                          <div className="overflow-x-auto">
                            <table className="w-full text-sm border border-border rounded-md">
                              ...
                              <tbody>
                                <tr className="border-t border-border">
                                  <td className="p-2">Veo 3.1 Fast</td>
                                  <td className="p-2">720p/1080p</td>
                                  <td className="p-2 text-right font-redhatmono">$0.15</td>
                                  <td className="p-2 text-right font-redhatmono">$1.20</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Veo 3.1 Standard</td>
                                  <td className="p-2">720p/1080p</td>
                                  <td className="p-2 text-right font-redhatmono">$0.40</td>
                                  <td className="p-2 text-right font-redhatmono">$3.20</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Veo 3.1 Fast</td>
                                  <td className="p-2">4K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.35</td>
                                  <td className="p-2 text-right font-redhatmono">$2.80</td>
                                </tr>
                                <tr className="border-t border-border">
                                  <td className="p-2">Veo 3.1 Standard</td>
                                  <td className="p-2">4K</td>
                                  <td className="p-2 text-right font-redhatmono">$0.60</td>
                                  <td className="p-2 text-right font-redhatmono">$4.80</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                        ...
                        <div id="pr-credits" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-4">
                            Credits are our universal currency. Each operation has a fixed credit
                            cost.
                          </p>
                              ...
                              <div className="space-y-1.5 text-sm">
                                {creditCosts
                                  ...
                                  .map((cost, i) => (
                                    <div
                                      key={i}
                                      className="flex justify-between items-center bg-secondary/40 border border-border rounded px-3 py-1.5"
                                    >
                                      <span className="text-muted-foreground">
                                        {cost.model} {cost.resolution}
                                      </span>
                                      <Badge variant="secondary" className="font-redhatmono">
                        ...
                        <div id="pr-packages" className="scroll-mt-20">
                          ...
                          <p className="text-muted-foreground text-sm mb-4">
                            What can you create with each package?
                          </p>
                          ...
                          <p className="text-xs text-muted-foreground mt-2">
                            *Estimates based on default models and resolutions. Actual usage may
                            vary.
                          </p>
                        </div>
