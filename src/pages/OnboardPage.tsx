...
const SectionHeading: React.FC<{ children: React.ReactNode; accent?: boolean }> = ({
  ...
  <h2
    className={cn(
      ...
      accent ? 'text-white' : 'text-neutral-100'
    )}
  >
    {children}
  </h2>
    ...
    <FadeIn>
      <div className="flex flex-col gap-3">
        ...
        <p className="text-neutral-400 text-sm max-w-xl leading-relaxed">
          Cada campo da guideline — cores, tipografia, voz, tokens — vira parâmetro de geração. Não
          é um PDF para ninguém ler. É uma API da identidade do seu cliente.
        </p>
      </div>
    </FadeIn>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-400 leading-relaxed">
              Frontify e Brandfolder armazenam e compartilham guidelines.{' '}
              <strong className="text-neutral-200">
                Visant usa as guidelines como contexto de geração IA.
              </strong>{' '}
              Cores/tipografia/voz viram parâmetros automáticos no Canvas, Mockup Machine, Plugin
              Figma e API pública.
            </p>
          </div>
        </div>
  ...
  <div className="flex flex-col gap-10">
    <FadeIn>
      <div className="flex flex-col gap-3">
        ...
        <SectionHeading accent>
          <span className="text-brand-cyan">30+ tipos de nó.</span>
          <br />
          Workflows visuais com IA.
        </SectionHeading>
        <p className="text-neutral-400 text-sm max-w-xl leading-relaxed">
          Cada nó tem um papel. Você conecta, configura e executa — a marca do cliente flui
          automaticamente por toda a pipeline.
        </p>
      </div>
    </FadeIn>
    ...
    <div className="flex flex-col gap-10">
      <FadeIn>
        <div className="flex flex-col gap-3">
          ...
          <p className="text-neutral-400 text-sm max-w-xl leading-relaxed">
            GPT-4o planeja os ângulos criativos usando os dados da guideline do cliente. Gera tudo
            em paralelo. Entrega campanha completa via API, MCP ou ChatNode.
          </p>
        </div>
      </FadeIn>
            ...
            <div className="flex flex-wrap gap-2">
              {CAMPAIGN_ANGLES.map((angle, i) => (
                <motion.span
                  ...
                  animate={{
                    backgroundColor:
                      active === i ? 'oklch(0.81 0.156 198.6 / 0.15)' : 'transparent',
                    borderColor:
                      active === i ? 'oklch(0.81 0.156 198.6 / 0.4)' : 'oklch(1 0 0 / 0.08)',
          ...
          <GlassPanel padding="md" className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              {[
                {
                  method: 'API REST',
                  detail: 'POST /api/canvas/generate-campaign',
                  icon: FileCode,
                },
                {
                  method: 'MCP Tool',
                  detail: 'create_ad_campaign { brandGuidelineId, productImageUrl }',
                  icon: Bot,
                },
                {
                  method: 'ChatNode',
                  detail: '"gera 20 ads para atletas" — linguagem natural',
                  icon: Activity,
                },
  ...
  <div className="flex flex-col gap-10">
    <FadeIn>
      <div className="flex flex-col gap-3">
        ...
        <p className="text-neutral-400 text-sm max-w-xl leading-relaxed">
          Figma, agentes externos, CI/CD, n8n. A guideline é uma API — qualquer sistema pode
          consumir.
        </p>
      </div>
    </FadeIn>
          ...
          >
            ...
            <ul className="flex flex-col gap-2">
              {integ.points.map((pt) => (
                <li
                  key={pt}
                  className="flex items-start gap-2 text-[10px] text-neutral-500 font-mono leading-relaxed"
                >
  ...
  <div className="flex flex-col gap-10">
    <FadeIn>
      <div className="flex flex-col gap-3">
        ...
        <SectionHeading accent>
          Do onboarding do cliente
          <br />
          <span className="text-brand-cyan">à entrega de campanha.</span>
        </SectionHeading>
        <p className="text-neutral-400 text-sm max-w-xl leading-relaxed">
          Fluxo completo para agências multi-cliente. Cada cliente tem sua guideline isolada, seu
          link de aprovação, seu canvas de criação.
        </p>
      </div>
    </FadeIn>
        ...
        <FadeIn key={step.step} delay={i * 0.1}>
          <div className="flex gap-5 group">
            ...
            <div className="pb-8 pt-1 flex flex-col gap-1">
              ...
              <p className="text-xs text-neutral-500 leading-relaxed max-w-lg">{step.desc}</p>
            </div>
          </div>
        </FadeIn>
      ))}
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-neutral-400 text-base md:text-lg max-w-2xl leading-relaxed">
                Não é documentação. É a identidade do cliente como API — alimentando geração IA,
                Canvas, Figma e agentes externos automaticamente.
              </p>
            </div>
          ...
          <FadeIn>
            <div className="border-t border-neutral-800 pt-12 flex flex-col items-center gap-6 text-center">
              ...
              <p className="text-neutral-500 text-sm max-w-md leading-relaxed">
                Em 10 minutos você tem cores, tipografia, voz e tokens estruturados — prontos para
                alimentar a geração IA.
              </p>
