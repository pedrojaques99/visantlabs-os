                ...
                {focusRegion && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-0.5 rounded hover:bg-white/5 text-neutral-500 hover:text-neutral-300 transition-colors"
                    >
                      <X size={10} />
                    </button>
                  </motion.div>
      ...
      <AnimatePresence mode="wait">
        ...
        {!hasItems ? (
          ...
          <motion.div
            key="workspace"
            {...fadeScale}
            className="relative w-full max-w-3xl rounded-2xl overflow-hidden border border-neutral-800 min-h-[300px] flex items-center justify-center"
            style={{
              background:
