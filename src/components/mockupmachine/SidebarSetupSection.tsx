...
export const SidebarSetupSection: React.FC<SidebarSetupSectionProps> = ({
  ...
  const { uploadedImage, referenceImages, designType, selectedModel, hasAnalyzed, isAnalyzing } =
    useMockup();

  const canAnalyze = uploadedImage && !hasAnalyzed;

  return (
    <div id="section-setup" className="px-4 mx-auto w-full max-w-4xl relative">
