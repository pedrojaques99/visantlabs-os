...
import { Dices, PenLine, Pickaxe, Check, Settings, Diamond, ChevronDown, ChevronUp, Zap } from 'lucide-react';
...
function ToggleRow({
    ...
    const content = (
        ...
        >
            ...
            <span className={cn(
                "text-[10px] uppercase tracking-widest font-mono transition-colors",
                checked ? "text-brand-cyan" : dark ? "text-neutral-500 group-hover:text-neutral-400" : "text-neutral-500 group-hover:text-neutral-700"
            )}>{label}</span>
        </div>
    );
                                    ...
                                    {autoGenerate ? (
                                        ...
                                        renderButton(
                                            ...
                                            isGeneratingPrompt || isGeneratingOutputs ? (
                                                ...
                                                isPromptReady ? <Pickaxe size={18} className="fill-current" /> : <PenLine size={18} />
                                            ),
                                            !!isPromptReady,
