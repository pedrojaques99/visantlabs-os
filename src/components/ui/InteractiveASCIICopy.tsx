...
export const InteractiveASCIICopy = ({
  isDarkMode,
  asciiArt = `                                                                                                                                     
brandidentidadeposicionamentoperceptionmeaningpropósitorelevanciaconsistencydiferenciaciónmemoriavaleurarchetypeterritorydiscursonarrativeexpression
símbolosystemcoherenciapersonalidadetonevoiceimpactoclarezadirectionintentionessencestratégiaexperiencerecognitionmarqueidentidadepositioningpercepción
symbolsistemacoerênciapersonnalitétonvozimpactclaritydireçãointenciónessenceestratégiaexpériencereconhecimentobrandidentityposicionamentoperception
marquesistemacoherenciapersonalidadetomvoiximpactoclarezadirecciónintentionessencestrategyexperiênciareconocimientoauthenticityconnectiontrustloyalty
autenticidadconnexionconfiançalealdadeculturainnovationlegadopromisevaleurposicionamientostorytellingbrandingdesigntypographycolorformasonidoodortactovision
purposevisiónmissionvaleursatitudecomportamientocultureinternapromesseentregaexperienceclientbuyerjourneytouchpointfidelizaçãobrandequitycultureinnovation
brandidentidadeposicionamentoperceptionmeaningpropósitorelevanciaconsistencydiferenciaciónmemoriavaleurarchetypeterritorydiscursonarrativeexpression
símbolosystemcoherenciapersonalidadetonevoiceimpactoclarezadirectionintentionessencestratégiaexperiencerecognitionmarqueidentidadepositioningpercepción
symbolsistemacoerênciapersonnalitétonvozimpactclaritydireçãointenciónessenceestratégiaexpériencereconhecimentobrandidentityposicionamentoperception
marquesistemacoherenciapersonalidadetomvoiximpactoclarezadirecciónintentionessencestrategyexperiênciareconocimientoauthenticityconnectiontrustloyalty
...
`,
  ...
  const getAccentColorWithOpacity = useCallback(
    (opacity: number) => {
      ...
      {avatarSrc && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div
            className="relative"
            style={{
              transform: `rotate(${avatarRotation + scrollProgress * 180}deg) scale(${
                1 - scrollProgress * 1
