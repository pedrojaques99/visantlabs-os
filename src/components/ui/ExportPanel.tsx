...
export const ExportPanel: React.FC<ExportPanelProps> = ({
  ...
  return (
    <div className={cn(
      ...
      {!embedded && <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-700/30">
        <h2 className="text-sm font-semibold text-neutral-200 font-mono">Export</h2>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            <label className="text-xs text-neutral-400 font-mono mb-1 block">Scale</label>
            <select
              value={selectedScale}
          ...
          {/* Format Selector */}
          <div className="flex-1">
            <label className="text-xs text-neutral-400 font-mono mb-1 block">Format</label>
            <select
        ...
        >
          {isExporting ? (
            <>
              <div className="w-3 h-3 border-2 border-neutral-400 border-t-transparent rounded-md animate-spin" />
              Exporting...
            </>
          ) : (
        ...
        <div className="border-t border-neutral-700/30 pt-4">
          ...
          {isPreviewExpanded && imageUrl && (
            <div className="relative w-full bg-neutral-900/30 rounded border border-neutral-700/30 overflow-hidden">
      ...
      <div className="px-4 py-3 border-t border-neutral-700/30 flex justify-end">
        <button
          onClick={() => { }}
          className="w-8 h-8 rounded-md bg-neutral-900/50 hover:bg-neutral-900/70 border border-neutral-700/30 flex items-center justify-center text-neutral-400 hover:text-neutral-300 transition-colors"
          title="Help"
        >
          <HelpCircle size={16} />
        </button>
