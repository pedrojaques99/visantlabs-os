...
export const AnalyzingImageOverlay: React.FC<AnalyzingImageOverlayProps> = ({ isVisible }) => {
  ...
  const statusMessages = useMemo(() => {
    ...
    return (
      (translations.mockup?.analysisStatusMessages as unknown as string[]) ?? [
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            theme === 'dark'
              ? '0 0 20px rgba(0, 0, 0, 0.3), inset 0 0 30px rgba(0, 0, 0, 0.3)'
              : '0 0 20px rgba(0, 0, 0, 0.1), inset 0 0 30px rgba(255, 255, 255, 0.5)',
        }}
      >
        {/* Content */}
