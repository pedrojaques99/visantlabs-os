    ...
    >
      <div className="space-y-1.5 py-1">
        ...
        {items.map((s, si) => (
          <div
            key={s.id}
            className="group/shadow border-b border-neutral-800 last:border-0 overflow-hidden"
          >
            {/* Always visible */}
            <div className="flex items-center gap-2 p-2">
              <div
                className="w-8 h-8 rounded shrink-0 bg-neutral-800 border border-neutral-800"
