        ...
        setMessages([
          {
            role: 'assistant',
            content:
              'Bem-vindo ao Chat Estratégico Admin. Selecione uma sessão ou inicie uma nova.',
            timestamp: new Date().toISOString(),
          },
        ]);
      }
    ...
    try {
      ...
      try {
        const {
          ...
          toolCalls,
          generationId,
        } = await adminChatApi.sendMessage(sessionId, currentInput, planModeActive, textMode, {
          model: selectedModel,
          aspectRatio,
          resolution,
        });
