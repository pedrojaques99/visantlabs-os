...
export const ChatSidebar = ({
  ...
  const [connectedStrategyData, setConnectedStrategyData] = useState(
    ...
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      try {
        ...
        if (nodeData.onAttachMedia) {
          ...
          const newNodeId = nodeData.onCreateNode(
            nodeId,
            'image',
            {
              mockup: {
      ...
      <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-neutral-700/30 bg-gradient-to-r from-neutral-900/40 to-neutral-900/20 backdrop-blur-sm min-w-0">
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            ...
            <h3 className="text-sm font-semibold text-neutral-200 tracking-tight truncate">
        ...
        <div className="px-4 py-2.5 border-b border-neutral-700/30 bg-gradient-to-r from-neutral-900/50 to-neutral-900/30 backdrop-blur-sm">
          <div className="flex items-center justify-between text-xs mb-2">
            ...
            <span className="text-neutral-400 text-xs">
              {' '}
              {t('canvasNodes.chatNode.nextCreditIn')} {messagesUntilNextCredit}{' '}
              {messagesUntilNextCredit > 1
                ? t('canvasNodes.chatNode.messagesPlural')
                : t('canvasNodes.chatNode.message')}{' '}
            </span>
          </div>
              ...
              {hasContext ? (
                <div className="space-y-3">
                  ...
                  <p className="text-neutral-300 font-medium">
                    {t('canvasNodes.chatNode.startConversationWithContext')}
                  </p>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-neutral-300 font-medium">
                    {t('canvasNodes.chatNode.startConversationWithAI')}
                  </p>
          ...
          <ChatInput
            ...
            placeholder={
              hasContext
                ...
                : t('canvasNodes.chatNode.typeYourMessage')
            }
