...
import {
  ...
  ToolPanelDisclosure, ToolPanelRow,
  InlineColorPicker, ChannelRow, ToolPanelExportActions,
      ...
      <ToolPanelContent>
        ...
        <ToolPanelSection title="PAPER & BLEND">
          <ToolPanelRow label="Paper">
            <InlineColorPicker value={store.paperColor} onChange={(v) => set('paperColor', v)} label="Paper color" />
          </ToolPanelRow>
