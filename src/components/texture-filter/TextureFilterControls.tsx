...
import {
  ...
  ToolPanelDisclosure, ToolPanelGrid,
  ToolPanelRow, ToolPanelSection, InlineColorPicker, ToolPanelExportActions,
  ...
  return (
    <ToolPanel className="flex-row">
      ...
      <ToolPanelContent>
        ...
        {/* Mode */}
        <ToolPanelSection title="Mode" id="sec-mode" onReset={() => {
        ...
        {/* Appearance */}
        <ToolPanelSection title="Appearance" id="sec-appearance" onReset={() => {
        ...
        {/* Position */}
        <ToolPanelSection title="Position" id="sec-position" onReset={() => {
            update('rotation', 0);
            update('offsetX', 0);
            update('offsetY', 0);
          }}>
        ...
        {/* Tile */}
        <ToolPanelSection title="Tile" id="sec-tile" onReset={() => {
            update('tileGapX', 0);
            update('tileGapY', 0);
          }}>
        ...
        <ToolPanelDisclosure label="Color" id="sec-color">
          ...
          {!store.useOriginalColor && (
            <ToolPanelRow label="Color">
              <InlineColorPicker value={store.textureColor} onChange={(v) => update('textureColor', v)} />
            </ToolPanelRow>
          )}
        </ToolPanelDisclosure>
