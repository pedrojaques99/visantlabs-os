...
export const UpscaleNode: React.FC<NodeProps<Node<UpscaleNodeData>>> = memo(
  ({ data, selected, id, dragging }) => {
    ...
    const upscaleModel: GeminiModel =
      targetResolution === '4K' ? GEMINI_MODELS.PRO : GEMINI_MODELS.NB2;
    ...
    return (
      ...
      >
        ...
        <NodeHeader
          icon={Maximize2}
          title={t('canvasNodes.upscaleNode.title')}
          selected={selected}
        />
