...
export const EdgeContextMenu: React.FC<EdgeContextMenuProps> = ({
  ...
  return (
    <div
      ref={menuRef}
      data-context-menu
      className="fixed z-50 bg-neutral-950/70 backdrop-blur-xl border border-neutral-800/50 rounded-md shadow-2xl min-w-[180px] flex flex-col overflow-hidden transition-all duration-200 ease-out"
      style={menuStyle}
    ...
    >
      ...
      <div className="p-2 overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-400 dark:scrollbar-thumb-neutral-700 scrollbar-track-transparent flex-1">
        <Button variant="ghost"
          ...
          className="w-full px-2 py-1.5 text-left text-sm text-neutral-400 hover:bg-neutral-800/50 hover:text-red-400 transition-colors duration-150 flex items-center justify-start gap-2 cursor-pointer rounded-md"
        >
