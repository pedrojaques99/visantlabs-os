    ...
    <DropdownMenu.Root open={true} onOpenChange={(open) => { if (!open) onClose(); }}>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          data-context-menu
          className="fixed z-50 bg-neutral-950/70 backdrop-blur-xl border-node border-neutral-800/50 rounded-md shadow-2xl min-w-[180px] flex flex-col overflow-hidden transition-all duration-200 ease-out"
          sideOffset={0}
