  ...
  return (
    ...
    >
      <div className="px-2 py-1.5 border-b border-zinc-700/30 flex items-center justify-between sticky top-0 bg-black/90 backdrop-blur-sm z-10">
        <span className="text-xs font-mono text-zinc-400 uppercase">Connection</span>
        <button
          onClick={onClose}
      ...
      <button
        ...
        className="w-full px-3 py-2 text-left text-sm text-zinc-300 hover:bg-zinc-800/50 hover:text-red-400 transition-colors flex items-center gap-2 font-mono cursor-pointer"
      >
        <Trash2 size={14} />
        Remove Connection
      </button>
