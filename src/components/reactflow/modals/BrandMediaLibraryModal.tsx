    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10px] font-mono text-neutral-600 uppercase tracking-tighter">{type === 'logo' ? 'Logotype' : 'Brand Image'}</p>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="px-1 truncate">
        <p className="text-[10px] font-mono font-bold text-neutral-500 uppercase tracking-tighter group-hover:text-brand-cyan transition-colors truncate">
          {label}
        </p>
      </div>
    </div>
