...
// Pure glyph→SVG conversion lives in @visant/extrude3d. Re-exported here so
// existing imports (`./engine/useFont`) keep working; an opentype.js Font
// structurally satisfies the package's OpenTypeFontLike.
export { textToSvg } from '@visant/extrude3d/fonts';
