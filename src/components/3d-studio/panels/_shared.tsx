...
export const MaterialCategoryTabs: React.FC<{ activeCat: string; store: StoreState }> = React.memo(({ activeCat, store }) => {
...
export function perlinNoise(ctx: CanvasRenderingContext2D, size: number, scale: number, intensity: number) {
