...
export const EditWorkflowModal: React.FC<EditWorkflowModalProps> = ({
  ...
  return createPortal(
    <div
      className="fixed inset-0 bg-neutral-950/80 backdrop-blur-sm z-[10000] flex items-center justify-center p-4 animate-fade-in"
      onClick={onClose}
    >
      <div
        className="relative max-w-md w-full bg-neutral-900 border border-neutral-800/60 rounded-xl shadow-2xl flex flex-col overflow-hidden animate-slide-up"
