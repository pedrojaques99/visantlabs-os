...
export const SPACING_TOKENS: SpacingToken[] = [
  ...
  { name: '--node-padding', variable: '--node-padding', description: 'Default node padding (p-8)' },
  {
    name: '--node-gap',
    variable: '--node-gap',
    description: 'Default gap between elements (gap-4)',
  },
  ...
  {
    name: '--node-space-y',
    variable: '--node-space-y',
    description: 'Default vertical spacing (space-y-4)',
  },
  {
    name: '--node-space-y-sm',
    variable: '--node-space-y-sm',
    description: 'Small vertical spacing (space-y-3)',
  },
  {
    name: '--node-space-y-lg',
    variable: '--node-space-y-lg',
    description: 'Large vertical spacing (space-y-5)',
  },
];
