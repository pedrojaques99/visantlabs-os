...
export const BrandGradientStopSchema = z
  .object({
    color: z.string(),
    position: z.number(),
  })
...
export const BrandGradientSchema = z
  .object({
    id: z.string(),
    name: z.string(),
...
export const BrandShadowSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    x: z.number(),
...
export const BrandBorderSchema = z
  .object({
    id: z.string(),
    name: z.string(),
    width: z.number(),
...
export const BrandMediaSchema = z
  .object({
    id: z.string().optional(),
    url: z.string(),
...
export const BrandGuidelineSchema = z
  .object({
    id: z.string().optional(),
...
/** GET list response */
export const BrandGuidelineListResponseSchema = z
  .object({
...
export const BrandGuidelineItemResponseSchema = z
  .object({
