// AUTO-GERADO por scripts/icon-usage-report.mjs — não editar à mão.
// 304 ícones no barrel, 2428 usos de JSX no total, 41 sem uso de JSX (só config/import).
export interface IconUsage {
  name: string;
  count: number;
  files: number;
}
export const ICON_USAGE_TOTAL = 2428;
export const ICON_USAGE: IconUsage[] = [
  {
    "name": "X",
    "count": 180,
    "files": 134
