...
export const MOCKUP_PRESETS: MockupPreset[] = [
  {
    ...
    prompt:
      'Product mockup: design embroidered on premium cap, centered with premium thread stitching. Neutral background, lighting highlights embroidery details. Realistic fabric texture and depth.',
  ...
  },
  {
    ...
    prompt:
      'Outdoor billboard mockup in São Paulo, Brazil. 9:3 aspect ratio, design displayed prominently. Sunny day, clear blue skies, modern buildings and São Paulo urban architecture. Realistic lighting, shadows, perspective. Integrated into cityscape with proper scale and depth.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
  ...
  },
  {
    ...
    prompt:
      'Minimalist studio mockup: iPhone 17 Pro displaying design as wallpaper. Minimal background, soft lighting. Design centered and scaled for screen. Realistic screen reflections, premium device details.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Product mockup: design printed on premium t-shirt, positioned with vibrant colors. Neutral background, lighting highlights print quality and fabric texture. Realistic fabric folds and depth, laid flat or on mannequin.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Business card mockup: clean modern layout, design displayed prominently with professional typography. Minimal background, soft lighting, subtle shadows for depth. Realistic paper texture, premium finish.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Minimalist studio mockup: premium ceramic mug with design printed. Minimal background, soft lighting. Design positioned and clearly visible. Realistic ceramic texture, subtle reflections, depth.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Product mockup: eco-friendly tote bag with design printed. Neutral background, lighting highlights design. Realistic fabric texture, natural folds, depth. High-quality sustainable appearance.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Instagram social media post mockup, 1:1 square format. Design displayed prominently with contemporary layout. Modern background, optimized for social media with good contrast and readability. Realistic screen or digital display effects.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Vertical poster mockup: design displayed prominently, modern eye-catching layout for advertising. Displayed on wall or clean environment, realistic lighting and shadows. Proper scale and perspective, design clearly visible and integrated.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Letterhead mockup: design prominently displayed at top, clean elegant layout for business correspondence. Minimal background, realistic paper texture, subtle shadows. Well-balanced composition, design integrated seamlessly.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    prompt:
      'Notebook mockup: design on cover, positioned and clearly visible. Minimal background, soft lighting. Realistic cover texture, subtle shadows, depth. Premium appearance, suitable for professional or personal use.',
    referenceImageUrl: '', // Será preenchido quando a imagem for enviada ao R2
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
  {
    ...
    description:
      'Corredor bebendo água de squeeze com design aplicado, motion blur, ângulo diagonal',
    prompt:
  ...
  },
  {
    ...
    referenceImageUrl:
      'https://assets.visantlabs.com/canvas/691e123b304058681621b711/693326b32885b62c1c30471f/node-image-1764976482248-7-1764975944966.png',
    aspectRatio: '16:9',
    model: GEMINI_MODELS.FLASH,
  },
];
