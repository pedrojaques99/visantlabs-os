...
export function useCanvasZoomPan({ getState, minZoom = 0.1, maxZoom = 10, zoomFactor = 1.1 }: UseCanvasZoomPanOptions) {
  ...
  const bindWheelToRef = useCallback((container: HTMLElement | null) => {
    if (!container) return;
