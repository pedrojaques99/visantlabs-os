    ...
    <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 ${
      ...
      <div className="flex items-center justify-center">
        ...
        <div 
          className={`w-full max-w-[300px] aspect-[2/3] flex items-center justify-center rounded-md ${
            theme === 'dark' ? 'bg-zinc-800/40 border border-zinc-700/60' : 'bg-zinc-100 border border-zinc-300'
          }`}
          style={{ display: imagePath ? 'none' : 'flex' }}
        >
          <span className={`text-sm font-manrope text-center px-4 ${
      ...
      <div className="space-y-4">
        <div>
          ...
          <h3 className={`text-xl font-semibold font-manrope mt-1 ${
        ...
        {isEditing ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className={`text-sm font-semibold font-manrope mb-2 ${
                theme === 'dark' ? 'text-zinc-300' : 'text-zinc-700'
              }`}>
                Exemplos:
              </h4>
