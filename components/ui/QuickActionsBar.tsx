      ...
      <div className="flex-shrink mx-2 flex flex-col items-center gap-2">
        <Tooltip content={t('mockup.surpriseMeTooltip')} position="top">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-md border hover:border-[#52ddeb]/30 hover:bg-[#52ddeb]/10 hover:text-[#52ddeb] transition-all text-sm font-mono transform hover:scale-[1.02] active:scale-100 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 shadow-lg hover:shadow-[#52ddeb]/10 cursor-pointer ${isAnimating ? 'dice-button-clicked' : ''} ${theme === 'dark'
