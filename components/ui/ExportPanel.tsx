    ...
    <div className="fixed right-0 top-0 h-full w-80 bg-[#2a2a2a] border-l border-zinc-700/30 z-50 flex flex-col shadow-2xl">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        <button
          ...
          className={cn(
            'w-full px-4 py-2.5 bg-[#52ddeb]/20 hover:bg-[#52ddeb]/30 border border-[#52ddeb]/30 rounded text-xs font-mono text-[#52ddeb] transition-colors flex items-center justify-center gap-2',
