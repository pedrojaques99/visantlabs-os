...
const pillButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md bg-transparent border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#52ddeb]/50 focus:ring-offset-2 focus:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
