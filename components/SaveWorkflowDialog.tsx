...
export const SaveWorkflowDialog: React.FC<SaveWorkflowDialogProps> = ({
    ...
    const modalContent = (
        ...
        >
            <div
                className="relative w-full max-w-2xl bg-zinc-900 border border-zinc-800/60 rounded-xl shadow-2xl flex flex-col overflow-hidden animate-slide-up"
            ...
            >
                ...
                <div className="flex items-center justify-between p-6 border-b border-zinc-800/60 bg-zinc-900/20 backdrop-blur-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-zinc-200 font-manrope tracking-tight">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <Input
                                ...
                                className="bg-zinc-900/50 border-zinc-800 focus:border-brand-cyan/50 focus:ring-brand-cyan/20"
                            />
                        </div>

                        {/* Category */}
                        <div className="space-y-2">
                            <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest ml-1 flex items-center gap-1.5">
                                <Folder size={12} />
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <Textarea
                                ...
                                className="min-h-[100px] bg-zinc-900/50 border-zinc-800 focus:border-brand-cyan/50 focus:ring-brand-cyan/20 resize-none"
                            />
                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-1">
                                    <label className="text-sm font-semibold text-zinc-300 flex items-center gap-2">
                                        <Globe size={16} className={cn("transition-colors", isPublic ? "text-brand-cyan" : "text-zinc-500")} />
                ...
                {/* Footer */}
                <div className="p-6 border-t border-zinc-800/60 bg-zinc-900/20 backdrop-blur-sm flex justify-end gap-3">
                    <Button
                        variant="ghost"
                        onClick={onClose}
                        disabled={isSaving}
