...
figma.ui.onmessage = async (msg: UIMessage) => {
  ...
  if (msg.type === 'SCAFFOLD_AGENT_LIBRARY') {
    const brand = (msg as any).brand as {
      name: string;
...
@agent:format instagram-feed, facebook-post`;
    ...
    discountText.fontName = { family: fontFamily, style: 'Bold' };
    ...
    promoTitle.fontName = { family: fontFamily, style: 'Bold' };
    ...
    promoSubtitle.fontName = { family: fontFamily, style: 'Regular' };
    ...
    ctaText.fontName = { family: fontFamily, style: 'Semi Bold' };
    ctaText.fontSize = 24;
...
@agent:format instagram-feed, linkedin-post`;
    ...
    infoTitle.fontName = { family: fontFamily, style: 'Bold' };
    ...
    infoBody.fontName = { family: fontFamily, style: 'Regular' };
...
@agent:format any`;
    ...
    cardDesc.fontName = { family: fontFamily, style: 'Regular' };
...
@agent:format any`;
    ...
    btnLabel.fontName = { family: fontFamily, style: 'Semi Bold' };
