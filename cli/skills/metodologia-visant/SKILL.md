---
name: metodologia-visant
description: |
  Metodologia oficial Visant para construção estratégica de marcas (9 etapas, 3 fases).
  USE FOR:
  - Gerar brandings completos seguindo a metodologia Visant
  - Revisar/auditar brandings existentes contra a metodologia
  - Entender a cascata de etapas e suas dependências
  - Escrever prompts estratégicos para cada etapa da branding machine
  - Garantir que outputs da IA sigam o padrão Visant (não genérico)
---

# Metodologia Visant — Referência Oficial

> "Marca não se desenha no feeling. É consequência de um processo bem feito."

## Estrutura: 3 Fases, 9 Etapas (Cascata)

Cada etapa alimenta a próxima. Pular etapas enfraquece a marca.

---

## FASE 1 — A ESTRATÉGIA (o cérebro)

### Etapa 01: Mensagem Central & Pilares

**Mensagem Central** = frase técnica INTERNA (não é slogan).
...
- **Diferencial:** O que destaca a oferta das demais do mesmo ramo.
...
### Etapa 02: Pesquisa de Mercado & Persona
...
### Etapa 03: Arquétipos & Tom de Voz

**Marca é gente.** Mix de primário + secundário (um só = unidimensional).
...
4. O Sábio (conhecimento, clareza)
5. O Cuidador (proteção, segurança)
6. O Governante (autoridade, controle)
7. O Mago (inovação, disrupção)
8. O Rebelde (mudança, liberdade)
9. O Criador (originalidade, expressão)
10. O Prestativo (servir, facilitar)
11. O Amante (desejo, sensorialidade)
12. O Bobo (humor, irreverência)

**Tom de Voz = 3 Pilares do Tom**, cada um com frase-exemplo.
...
**Sugestão de Slogan:** A frase final do manifesto vira candidata a slogan.

---

## FASE 2 — A IDENTIDADE VISUAL (o rosto)

### Etapa 05: Logotipo & Geometria

**3 fases:** Conceito → Esboço → Construção & Teste

- Listar o que o símbolo precisa comunicar (a partir dos Pilares e Arquétipo)
...
### Etapa 06: Cromatismo & Tipografia

Paleta + tipografia = **80% do tom** de uma marca.

**Paleta — Cor nomeada é cor com propósito:**
Cada cor recebe um nome que comunica quando usá-la.
...
### Etapa 07: Sistema Gráfico & Layouts
...
4. **Grids editoriais:** Malha que organiza posts, páginas, apresentações.

---

## FASE 3 — O RITUAL (a entrega)

### Etapa 08: Apresentação (40 slides)
...
### Etapa 09: Manual & Entrega (Brand System)

3 camadas: Entendimento (manual) | Operação (arquivos) | Preservação (regras de uso)

---

## O Decálogo Visant

1. Marca não se desenha no feeling. É consequência de um processo bem feito.
2. Com estratégia e tema visual definidos, a estética ganha personalidade única.
3. Descobrir os desejos do público é o que faz os clientes comprarem uma marca.
4. Pesquisa de mercado é essencial para achar o que ninguém está fazendo.
5. Uma marca forte é reconhecida mesmo sem o logo aparecer.
6. Uma apresentação bem feita vende o processo.
7. O trabalho só termina quando a marca resiste ao tempo sozinha.
8. Processos liberam espaço mental para você ser criativo.
9. Uma boa imersão de marca é o que mais evita alterações.
10. A meta é fazer clientes virarem fãs antes de conhecerem o produto.

---

## Aplicação na Branding Machine
