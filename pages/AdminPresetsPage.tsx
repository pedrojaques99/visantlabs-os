            ...
            <div className="space-y-6">
              ...
              <Card className="bg-zinc-900 border border-zinc-800/50 rounded-xl hover:border-[#52ddeb]/30 transition-all duration-300 shadow-lg">
                ...
                {batchResult && !isBatchModalOpen && (
                  <div className={`mb-4 border rounded-xl p-4 text-sm font-mono ${
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <Card className="bg-zinc-900 border border-zinc-800/50 rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4 mb-6">
                ...
                {batchResult && (
                  <div className={`border rounded-md p-4 text-sm font-mono ${
                    batchResult.created > 0
                      ? 'bg-green-500/10 border-green-500/30 text-green-400'
                      : 'bg-red-500/10 border-red-500/30 text-red-400'
                  }`}>
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  variant="outline"
                  className="font-mono border-zinc-700/60 hover:border-[#52ddeb]/30"
                >
                  Validar JSON
                </Button>
                <Button
                  ...
                  <div className="space-y-2">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-2 bg-black/40 border border-zinc-700/50 rounded-md text-zinc-300 font-mono text-sm focus:outline-none focus:border-[#52ddeb]/50"
                      />
                      <button
                        type="button"
                        onClick={() => {
