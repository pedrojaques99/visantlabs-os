...
const FEMALE_NAMES = new Set([
  'maria', 'ana', 'julia', 'juliana', 'beatriz', 'mariana', 'carla', 'camila', 'fernanda',
  'patricia', 'sofia', 'sophia', 'isabela', 'isabella', 'larissa', 'leticia', 'gabriela',
  'amanda', 'bruna', 'rafaela', 'luiza', 'helena', 'laura', 'clara', 'alice', 'lola',
  'emma', 'olivia', 'mia', 'charlotte', 'sarah', 'sara', 'emily', 'jessica', 'jennifer',
  'lisa', 'anna', 'elena', 'nina', 'paula', 'renata',
]);
const MALE_NAMES = new Set([
  'joao', 'jose', 'pedro', 'lucas', 'gabriel', 'rafael', 'gustavo', 'felipe', 'bruno',
  'rodrigo', 'ricardo', 'carlos', 'paulo', 'marcos', 'andre', 'thiago', 'tiago', 'diego',
  'eduardo', 'fernando', 'leonardo', 'matheus', 'vinicius', 'daniel', 'henrique', 'caio',
  'james', 'john', 'robert', 'michael', 'william', 'david', 'mark', 'tom', 'thomas',
  'alex', 'chris', 'ryan', 'kevin', 'jorge', 'luiz', 'luis',
]);
