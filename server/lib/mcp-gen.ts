...
const PLATFORM_TOOLS: PlatformToolDef[] = [
  ...
  },
  {
    ...
    properties: {
      ...
      scopes: { type: 'array', items: { type: 'string', enum: ['read', 'write', 'generate'] } },
      jwt: { type: 'string' },
    },
    cost: 'free',
    category: 'auth',
  ...
  },
  {
    ...
    properties: {
      ...
      size: { type: 'string', enum: ['1K', '2K', '4K'], default: '4K' },
    },
    cost: 'credits',
    category: 'moodboard',
    auth: true,
  },
  {
    ...
    properties: {
      images: {
        ...
        items: {
          type: 'object',
          properties: { id: { type: 'string' }, base64: { type: 'string' } },
        },
      },
    },
    cost: 'credits',
  ...
  {
    name: 'mockup-list',
    description: 'List mockups created by the authenticated user. Supports pagination.',
    required: [],
    properties: { limit: { type: 'integer', default: 20 }, skip: { type: 'integer', default: 0 } },
    cost: 'free',
    category: 'mockups',
    auth: true,
  },
  {
    name: 'mockup-get',
    description: 'Get a single mockup by its ID, including image URL, prompt, and metadata.',
    required: ['id'],
  ...
  },
  {
    ...
    description:
      'Generate a mockup placing a design into a realistic scene. Pass the design as referenceImages URL; describe only the scene in the prompt. See server instructions for workflow.',
    required: ['prompt'],
    properties: {
      prompt: {
        type: 'string',
        description: 'Scene/environment ONLY — surface, lighting, camera angle, background.',
      },
      ...
      referenceImages: {
        type: 'array',
        items: { type: 'string' },
        description: 'URLs of the design/artwork. Get URLs via upload-image.',
      },
    },
    cost: 'credits',
    category: 'mockups',
  ...
  {
    name: 'mockup-delete',
    description: 'Permanently delete a mockup by ID.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'mockups',
  ...
  // ---- AI ----
  {
    ...
    properties: {
      ...
      label: { type: 'string', description: 'Optional label for organization.' },
    },
    cost: 'free',
    category: 'ai',
    auth: true,
  },
  {
    ...
    description:
      'Generate an image from a text prompt. No brand injection, no project saving. For placing existing designs in scenes, use mockup-generate instead. Costs credits.',
    required: ['prompt'],
    properties: {
      prompt: { type: 'string' },
      model: {
      ...
      referenceImages: {
        type: 'array',
        items: { type: 'string' },
        description: 'Reference URLs or base64. Use upload-image for local files.',
      },
      seed: { type: 'integer' },
    },
    cost: 'credits',
  ...
  },
  {
    ...
    required: [],
    properties: { imageUrl: { type: 'string', format: 'uri' }, base64: { type: 'string' } },
    cost: 'free',
    category: 'ai',
    auth: true,
  },
  {
    name: 'image-extract-url',
    description:
    ...
    required: ['url'],
    properties: { url: { type: 'string', format: 'uri' }, limit: { type: 'integer', default: 80 } },
    cost: 'free',
    category: 'ai',
    auth: true,
  },
  ...
  },
  {
    ...
    required: ['prompt'],
    properties: { prompt: { type: 'string' }, step: { type: 'string' } },
    cost: 'credits',
    category: 'branding',
    auth: true,
  },
  ...
  },
  {
    ...
    description: 'Permanently delete a branding project by ID.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'branding',
  ...
  {
    name: 'brand-guidelines-upload-logo',
    description:
  ...
  },
  {
    ...
    required: ['id', 'logoId'],
    properties: { id: { type: 'string' }, logoId: { type: 'string' } },
    cost: 'free',
    category: 'brand-guidelines',
    auth: true,
  },
  ...
  {
    name: 'brand-guidelines-delete-media',
    description: 'Delete a media asset from a brand guideline by its media ID.',
    required: ['id', 'mediaId'],
  ...
  {
    name: 'brand-guidelines-duplicate',
    description:
  ...
  {
    name: 'brand-guidelines-restore-version',
    description:
  ...
  {
    name: 'brand-guidelines-compliance-check',
    description:
  ...
  },
  {
    ...
    properties: {
      id: { type: 'string' },
      source: { type: 'string', enum: ['url', 'text'] },
      url: { type: 'string' },
      text: { type: 'string' },
    },
    cost: 'credits',
  ...
  },
  {
    ...
    required: ['id'],
    properties: { id: { type: 'string' }, disable: { type: 'boolean' } },
    cost: 'free',
    category: 'brand-guidelines',
    auth: true,
  },
  {
    name: 'brand-guidelines-versions',
    description:
  ...
  {
    name: 'brand-guidelines-public',
    description: 'Get a public brand guideline by its slug. No authentication required.',
    required: ['slug'],
  ...
  {
    name: 'canvas-get',
    description: 'Get a canvas project by ID, including elements, collaborators, and metadata.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'canvas',
  ...
  {
    name: 'canvas-create',
    description: 'Create a new empty canvas (whiteboard) project.',
    required: ['name'],
  ...
  {
    name: 'canvas-delete',
    description: 'Permanently delete a canvas project by ID.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'canvas',
  ...
  },
  {
    ...
    required: ['csv'],
    properties: { csv: { type: 'string' }, preview_rows: { type: 'integer', default: 5 } },
    cost: 'free',
    category: 'canvas',
    auth: false,
  },
  {
    name: 'canvas-list-projects',
    description: 'List canvas projects for the authenticated user with node type summary.',
    required: [],
  ...
  {
    name: 'budget-get',
    description: 'Get a budget document by ID, including line items, totals, and client info.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'budget',
  ...
  {
    name: 'budget-delete',
    description: 'Permanently delete a budget project by ID.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'budget',
  ...
  },
  {
    ...
    description: 'Duplicate an existing budget project. Returns the new project.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'budget',
  ...
  // ---- Creative ----
  {
    ...
    description: 'List creative studio projects owned by the authenticated user.',
    required: [],
    properties: { limit: { type: 'integer', default: 20 }, skip: { type: 'integer', default: 0 } },
    cost: 'free',
    category: 'canvas',
  ...
  {
    name: 'creative-projects-delete',
    description: 'Permanently delete a creative project by ID.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'canvas',
  ...
  // ---- Document ----
  {
    ...
    description:
      'Extract content from a PDF using a 2-phase pipeline: algorithmic (exact colors, fonts, embedded images) then Gemini semantic analysis. Returns markdownText plus brand tokens.',
    required: ['output'],
    properties: {
      pdf_base64: { type: 'string' },
      pdf_filename: { type: 'string' },
      pdf_path: { type: 'string' },
      output: { type: 'string', enum: ['disk', 'inline'] },
      include_brand_tokens: { type: 'boolean', default: true },
    },
    cost: 'credits',
    category: 'ai',
    auth: true,
  ...
  {
    name: 'community-preset-get',
    description: 'Get a single community preset by ID. No auth required.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'community',
  ...
  {
    name: 'community-preset-create',
    description: 'Create a new community preset with prompt, category, and metadata.',
    required: ['name', 'description', 'prompt', 'category'],
    properties: {
      name: { type: 'string' },
  ...
  {
    name: 'community-preset-update',
    description: 'Update your own community preset. Only provided fields are changed.',
    required: ['id'],
    properties: {
      id: { type: 'string' },
      name: { type: 'string' },
  ...
  {
    name: 'community-preset-delete',
    description: 'Delete your own community preset permanently.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'community',
  ...
  {
    name: 'community-preset-like',
    description: 'Toggle like/unlike on a community preset. Returns updated count.',
    required: ['id'],
    properties: { id: { type: 'string' } },
    cost: 'free',
    category: 'community',
  ...
  {
    name: 'community-my-presets',
    description: 'List your own community presets (approved and pending).',
    required: [],
    properties: { limit: { type: 'integer', default: 20 }, skip: { type: 'integer', default: 0 } },
    cost: 'free',
    category: 'community',
  ...
  },
  {
    ...
    description: 'Browse public community creator profiles. No auth required.',
    required: [],
