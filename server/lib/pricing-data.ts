...
export const GOOGLE_OFFICIAL_PRICING = {
  ...
  video: {
    ...
    'veo-3.1-generate-preview': { '720p/1080p': 0.4, '4K': 0.6 },
  },
...
export const CREDIT_COSTS: PricingTier[] = [
  ...
  {
    model: 'AI Text (single call)',
    modelId: 'gemini-text-single',
    resolution: '~2K tokens',
    googlePriceUSD: 0.001,
    creditsRequired: 1,
    category: 'text',
  },
