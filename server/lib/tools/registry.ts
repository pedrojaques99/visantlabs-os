...
export const FIGMA_TOOLS: FigmaTool[] = [
  ...
  },
  {
    ...
    category: 'MCP',
    description:
      'Get rich design context for a Figma selection. Provides structured JSON with layout, typography, and color tokens.',
    schema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    category: 'CREATION',
    description:
      'Cria um frame container com auto-layout. Essencial para seções, telas e grupos organizados.',
    schema: {
      type: 'object',
      properties: {
        props: {
          ...
          properties: {
            ...
            layoutMode: {
              ...
              description: 'Modo de auto-layout',
            },
  ...
  },
  {
    ...
    category: 'ADVANCED',
    description:
      'Cria um componente mestre novo e reutilizável. Use para elementos que se repetem no design.',
    schema: {
      type: 'object',
      properties: {
        props: {
  ...
  },
  {
    ...
    schema: {
      ...
      properties: {
        ...
        componentRefs: {
          type: 'array',
          items: { type: 'string', description: 'Ref do componente' },
          description: 'Lista de Refs dos componentes',
        },
  ...
  },
  {
    ...
    category: 'ADVANCED',
    description:
      'Cria vetores a partir de uma string SVG. Ideal para ícones e ilustrações personalizadas.',
    schema: {
      type: 'object',
      properties: {
    ...
    schema: {
      ...
      properties: {
        ...
        scaleMode: {
          ...
          default: 'FILL',
          description: 'Modo de escala da imagem',
        },
      },
      required: ['imageUrl'],
    },
      ...
      properties: {
        props: {
          ...
          properties: {
            ...
            fills: {
              type: 'array',
              items: { type: 'object', description: 'Paint' },
  ...
  },
  {
    ...
    category: 'ADVANCED',
    description:
      'Extrai as cores dos fills da seleção atual e cria variáveis de cor no library do Figma, usando o nome de cada camada como nome da variável. Batch: processa todos os elementos selecionados de uma vez.',
    schema: {
      type: 'object',
      properties: {
        collectionName: {
          type: 'string',
          description: 'Nome da coleção de variáveis (padrão: "Colors")',
        },
      },
      required: [],
    },
  ...
  },
  {
    ...
    category: 'ADVANCED',
    description:
      'Percorre nós recursivamente e vincula cada fill/stroke hardcoded à variável de cor mais próxima por distância RGB. Substitui cores hardcoded por tokens do design system.',
    schema: {
      type: 'object',
      properties: {
        threshold: {
          type: 'number',
          description: 'Distância máxima para match (0-1, padrão: 0.05)',
        },
        scope: {
          type: 'string',
          enum: ['selection', 'page'],
          description: 'Escopo (padrão: selection)',
        },
  ...
  },
  {
    ...
    category: 'ADVANCED',
    description:
      'Solicita scan da página inteira quando os elementos mencionados pelo usuário não estão na seleção atual. O sistema re-envia o comando com contexto completo automaticamente.',
    schema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    schema: {
      ...
      properties: {
        nodeIds: {
          type: 'array',
          items: { type: 'string', description: 'IDs dos nós' },
  ...
  },
  {
    ...
    category: 'EDIT',
    description:
      'Altera propriedades de estilo de um texto SEM mudar o conteúdo. Use para fontSize, fontFamily, textAutoResize, etc.',
    schema: {
      type: 'object',
      properties: {
        ...
        textAutoResize: {
          ...
          description: 'Como o texto redimensiona',
        },
        textAlignHorizontal: {
          type: 'string',
        ...
        lineHeight: {
          type: 'object',
          description: '{ value: number, unit: "PIXELS" | "PERCENT" | "AUTO" }',
        },
        letterSpacing: {
          type: 'object',
          description: '{ value: number, unit: "PIXELS" | "PERCENT" }',
        },
