/**
 * Riso GLSL Shaders — shared between client and server.
 *
 * Single source of truth for vertex and fragment shader source code.
 * Client: src/components/riso/RisoRenderer.ts
 * Server: server/services/imageLab/risoRenderer.ts
 */
